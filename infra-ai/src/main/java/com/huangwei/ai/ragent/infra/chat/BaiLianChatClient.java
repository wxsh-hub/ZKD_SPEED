...
package com.huangwei.ai.ragent.infra.chat;
...
import com.huangwei.ai.ragent.infra.config.AIModelProperties;
import com.huangwei.ai.ragent.infra.enums.ModelProvider;
import com.huangwei.ai.ragent.infra.enums.ModelCapability;
import com.huangwei.ai.ragent.infra.http.HttpMediaTypes;
import com.huangwei.ai.ragent.infra.http.ModelClientErrorType;
import com.huangwei.ai.ragent.infra.http.ModelClientException;
import com.huangwei.ai.ragent.infra.http.ModelUrlResolver;
...
public class BaiLianChatClient implements ChatClient {
    ...
    private JsonArray buildMessages(ChatRequest request) {
        ...
        List<com.huangwei.ai.ragent.framework.convention.ChatMessage> messages = request.getMessages();
        if (CollUtil.isNotEmpty(messages)) {
            for (com.huangwei.ai.ragent.framework.convention.ChatMessage m : messages) {
    ...
    private String toOpenAiRole(com.huangwei.ai.ragent.framework.convention.ChatMessage.Role role) {
        return switch (role) {
            case SYSTEM -> "system";
            case USER -> "user";
